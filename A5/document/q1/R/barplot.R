...
barplot(incdata, main="Followers of Followers on Twitter", xlab="Followers sorted by increasing number of Followers", ylab="Number of Followers", col=cols[pos + 1],xlim = c(0,175), ylim=c(0, 4000))
